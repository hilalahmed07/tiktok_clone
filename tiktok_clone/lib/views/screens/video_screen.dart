                          ...
                          children: [
                            Expanded(
                              child: Container(
                                ...
                                child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
                                  Text(
                                    data.username,
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: CirleAnimation(child: buildMusicAlbum(data.profilePhoto)),
                                  ),
                                ],
                              ),
                            )
